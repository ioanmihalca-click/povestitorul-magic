        ...
        <div class="overflow-hidden bg-white shadow-lg rounded-3xl">
            <div class="p-6 bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100">
                ...
                <div class="max-w-2xl p-4 mx-auto bg-white shadow-inner rounded-xl">
                    ...
                    @if ($post->story->has_audio && $post->story->audio_url)
                        <div class="p-4 mb-4 bg-white rounded-lg shadow-md">
                            ...
                            <audio controls controlsList="nodownload" class="w-full">
                                <source src="{{ $post->story->audio_url }}" type="audio/mpeg">
                ...
                <div class="max-w-xl mx-auto mt-12 space-y-8">
                    <p class="text-xl text-center text-gray-700">Îți place această poveste? <br> Înregistrează-te pentru
                        a crea, a citi sau a asculta mai multe!</p>
                    <div
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-indigo-600">Alege dacă dorești poveste cu text și ilustrație
                                        sau cu versiune audio inclusă</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2 text-sm">
                                        <p class="text-indigo-600"><i class="mr-2 text-yellow-500 fas fa-star"></i>Alege
                                            din
                                            coșulețul cu idei</p>
